...
from wrapper import ClipRewardWrapper, FrameSkipMaxPoolWrapper
...
env = gym.make("ALE/AirRaid-v5", render_mode="rgb_array", frameskip=1)
...
model.compile()
model.to(device="mps")
agent = AirRaidAgent(env, model, learning_rate=0.0002, initial_epsilon=1.0, final_epsilon=0.01, decay_steps = episode_num // 5, discount_factor=0.99, window_size=window_size, memory_size=200000, frame_size=(84, 84), use_target_model=True, double_DQN=False)
agent.to("mps")

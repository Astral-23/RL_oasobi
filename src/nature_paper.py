...
agent = AirRaidAgent(env, model, learning_rate=0.001, initial_epsilon=1.0, final_epsilon=0.01, decay_steps = episode_num // 5, discount_factor=0.99, window_size=window_size, memory_size=200000, frame_size=(120, 120), use_target_model=True, double_DQN=False)
agent.to("cuda")
